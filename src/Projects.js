    ...
    <div className="row align-items-center" id="align_left">
      ...
      <div className="col-md-8 p-5">
        ...
        <h2 className="fw-bolder">숭실대학교 동아리연합회</h2>
                  2022.10 - 2024.1 (팀⇾개인 프로젝트)<br/><br/>
                 <p >
                    <b>기존 사용하던 네이버 카페를 대체하기 위한 숭실대학교 동아리연합회 웹사이트</b>를 제작했습니다. <br/>
                    동아리 소개 페이지, 이메일 발송, 게시물 작성, 계정 관리 등의 기능을 구현했습니다.
                  
                </p>
                  
                  <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                      
                                    <Button variant="outline-dark" className="btn px-3 py-3 me-sm-3 fs-6 fw-bolder" href="http://ssudy.com" target="_blank" rel="noopener noreferrer">
                Github
              </Button>
  ...
  <div className="card-body p-0">
    <div className="row align-items-center" id="align_left">
      ...
      <div className="col-md-8 p-5">
        ...
        <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
          <Button variant="outline-primary" className="btn px-3 py-3 me-sm-3 fs-6 fw-bolder" href="https://github.com/Signal" target="_blank" rel="noopener noreferrer">
            다운로드
          </Button>
      ...
      <div className="col-md-8 p-5">
        ...
        <h2 className="fw-bolder">Signal</h2>
                ...
                <p >
                  ...
                  <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
              <Button variant="outline-dark" className="btn px-3 py-3 me-sm-3 fs-6 fw-bolder" href="https://github.com/Signal" target="_blank" rel="noopener noreferrer">
                Github
              </Button>
