        ...
        <div className="card border-0 rounded-4 mb-5">
          ...
          <h4 className="text-secondary fw-bolder mb-0"><b>2024</b></h4>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 CES 2024(Consumer Electronics Show 2024) 참관
                </div>
              </Col>
          ...
          <h4 className="text-secondary fw-bolder mb-0"><b>2023</b></h4>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 K-PaaS 활용 디지털 사회혁신 서비스 개발 공모전 참여
                </div>
              </Col>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 - AI 법률자료 분석 커뮤니티 웹사이트 [너울] 서비스 시작
                </div>
              </Col>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 2023 KB금융그룹 DFIC(Digital Finance Innovation Course)
                </div>
              </Col>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 2023 우리금융그룹 WDA(Woori Digital Academy)
                </div>
              </Col>
          ...
          <h4 className="text-secondary fw-bolder mb-0"><b>2022</b></h4>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 숭실대학교 제24대 전자정보공학부 학생회 SIGNAL 가입
                </div>
              </Col>
            ...
            <Row className="align-items-center">
              ...
              <Col className="text-lg-start">
                  ...
                  <div className="text-primary fw-bolder mb-2"><div className="d-flex align-items-center justify-content-between mb-4">
          <h4 className="text-secondary fw-bolder mb-0">2021</h4>
        </div>
            ...
            <Row className="align-items-center">
              ...
              <Col className="text-lg-start">
                  ...
                  <div className="text-primary fw-bolder mb-2"><div className="d-flex align-items-center justify-content-between mb-4">
          <h4 className="text-secondary fw-bolder mb-0">2020</h4>
        </div>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 서울디지털재단 2020 스마트시민랩 커뮤니티 지원사업 선정(~2020.12)
                </div>
              </Col>
            ...
            <Row className="align-items-center">
              ...
              <Col className="text-lg-start">
                  ...
                  <div className="text-primary fw-bolder mb-2"><div className="d-flex align-items-center justify-content-between mb-4">
          <h4 className="text-secondary fw-bolder mb-0">2019</h4>
        </div>
            ...
            <Row className="align-items-center">
              ...
              <Col className="text-lg-start">
                  ...
                  <div className="text-primary fw-bolder mb-2"><div className="d-flex align-items-center justify-content-between mb-4">
          <h4 className="text-secondary fw-bolder mb-0">2016</h4>
        </div>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 2016 1학기 KAIST Youth Scientist Camp 참여
                </div>
              </Col>
            ...
            <Row className="align-items-center">
              ...
              <Col className="text-lg-start">
                  ...
                  <div className="text-primary fw-bolder mb-2"><div className="d-flex align-items-center justify-content-between mb-4">
          <h4 className="text-secondary fw-bolder mb-0">2015</h4>
        </div>
            ...
            <Row className="align-items-center gx-5">
              ...
              <Col lg={8}>
                <div className="text-start p-1"> 
                 2015 1학기 서울교육대학교 과학영재교육원 탐구발표대회 우수상
                </div>
              </Col>
            ...
            <Row className="align-items-center">
              ...
              <Col className="text-lg-start">
                  ...
                  <div className="text-primary fw-bolder mb-2"><div className="d-flex align-items-center justify-content-between mb-4">
          <h4 className="text-secondary fw-bolder mb-0">2003</h4>
        </div>
